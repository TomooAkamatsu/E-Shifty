...
function useVisualElementContext() {
    return React.useContext(MotionContext).parent;
}
    ...
    return {
        ...
        notify: function (a, b, c) {
            ...
            if (!subscriptions.size)
                return;
            try {
                for (var subscriptions_1 = tslib.__values(subscriptions), subscriptions_1_1 = subscriptions_1.next(); !subscriptions_1_1.done; subscriptions_1_1 = subscriptions_1.next()) {
...
var visualElement = function (_a) {
    ...
    return function (_a, options) {
         ...
         */
        var baseTarget = tslib.__assign({}, visualState.values);
        // Internal methods ========================
        /**
        ...
        var element = tslib.__assign(tslib.__assign({ 
            ...
            pointTo: function (newLead) {
                ...
                unsubscribeFromLeadVisualElement = popmotion.pipe(newLead.onSetAxisTarget(element.scheduleUpdateLayoutProjection), newLead.onRender(render));
            }, 
            // TODO: Clean this up
...
function buildSVGAttrs(state, _a, layoutState, options, transformTemplate) {
    ...
    latest = tslib.__rest(values, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]);
...
function useSnapshotOfLeadVisualElement(layoutId) {
    ...
    return useConstant(function () {
        ...
        return lead ? tslib.__assign({}, lead.getLatestValues()) : undefined;
    });
}
function useDomVisualElement(Component, props, isStatic, ref) {
    ...
    useIsomorphicLayoutEffect(function () {
        var _a;
        visualElement.updateProps(tslib.__assign(tslib.__assign({}, props), { layoutId: layoutId }));
        /**
...
function createMotionComponent(Component, _a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(MotionContext.Provider, { value: motionContext }, component),
            features));
    }
...
function createCrossfadeState(state, forceCrossfade) {
    ...
    function animateProgress(to, transition) {
        ...
        animate(crossfadeProgress, to, tslib.__assign(tslib.__assign({}, (transition ||
    ...
    function updateValues() {
        ...
        if (forceCrossfade || follow.isPresenceRoot || lead.isPresenceRoot) {
            ...
            leadValues.values.opacity = popmotion.mix(0, leadTargetOpacity, easeCrossfadeIn(p));
        }
...
function mixBorderRadius(from, to, fromValues, toValues, p) {
    ...
    for (var i = 0; i < numBorders; i++) {
        ...
        if (typeof fromRadius === "number" && typeof toRadius === "number") {
            fromValues[borderLabel] = toValues[borderLabel] = popmotion.mix(fromRadius, toRadius, p);
        }
    }
    if (fromLatest.rotate || toLatest.rotate) {
        fromValues.rotate = toValues.rotate = popmotion.mix(fromLatest.rotate || 0, toLatest.rotate || 0, p);
    }
}
...
exports.createCrossfadeState = createCrossfadeState;
