...
import { CrossfadeState, Snapshot } from "../components/AnimateSharedLayout/utils/stack";
...
export declare type VisualElementOptions<Instance> = {
    ref?: Ref<Instance>;
...
export declare type ExtendVisualElement<Extended extends VisualElement, Element = any> = (element: VisualElement<Element>) => Extended;
export declare type UseVisualElement<E, P = MotionProps> = (Component: string | React.ComponentType<P>, props: MotionProps & P, isStatic?: boolean, ref?: Ref<E>) => VisualElementTree;
/**
